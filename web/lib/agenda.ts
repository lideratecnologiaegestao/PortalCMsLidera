...
/** Tipos de item + rótulo + cor padrão. (A UI mostra o subconjunto relevante.) */
export const TIPOS_AGENDA: { v: string; label: string; cor: string }[] = [
  ...
  { v: 'sessao', label: 'Sessão', cor: '#dc3545' },
  { v: 'votacao', label: 'Votação', cor: '#e83e8c' },
  { v: 'mocao', label: 'Moção', cor: '#6610f2' },
