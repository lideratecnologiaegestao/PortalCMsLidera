  ...
  return (
    <div className="space-y-4">
      <AdminHeader
        ...
        description="Cursos, módulos, aulas, provas, inscrições e certificados da Escola do Legislativo."
      />

      {/* Abas */}
      <div className="border-b border-border" role="tablist" aria-label="Seções da Escola Legislativa">
