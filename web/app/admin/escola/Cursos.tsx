...
/**
 * Admin — Escola Legislativa / Cursos (CRUD + drill-down de conteúdo).
 *
      ...
      <form onSubmit={salvar} className="space-y-4" noValidate>
        ...
        <div>
          ...
          <input
            ...
            placeholder="ex.: Processo Legislativo na Prática"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="processo-legislativo-na-pratica"
          />
        </div>
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <p className="text-sm text-fg/70">
          Cursos da Escola Legislativa: dados gerais, certificação automática e publicação. Use
