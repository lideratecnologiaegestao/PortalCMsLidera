 ...
 * Legislativa. Server Component — SSR. WCAG 2.1 AA. Não indexada (privacidade).
 */
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: 'Verifique a autenticidade de um certificado emitido pela Escola Legislativa.',
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-12">
      <nav aria-label="Trilha" className="text-sm text-muted-fg">
        <Link href="/escola" className="underline">Escola Legislativa</Link> <span aria-hidden>›</span> Validação
      </nav>
      ...
      <p className="mt-8">
        <Link href="/escola" className="text-primary underline">← Voltar para a Escola Legislativa</Link>
      </p>
    </main>
  );
}
