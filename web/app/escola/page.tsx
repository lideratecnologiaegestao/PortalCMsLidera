/**
 * Página pública: Escola Legislativa — catálogo de cursos.
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Escola Legislativa',
    description: 'Cursos gratuitos de educação cidadã e legislativa da Câmara Municipal, com certificado.',
...
export default async function EscolaPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      <h1 className="text-2xl font-bold text-fg">Escola Legislativa</h1>
      <p className="mt-1 text-muted-fg">
        Cursos gratuitos de educação cidadã e legislativa. Inscreva-se, conclua e receba seu certificado.
      </p>
