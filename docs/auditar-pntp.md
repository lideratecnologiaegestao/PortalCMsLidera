...
argument-hint: [tenant/câmara ou URL do portal — opcional]
---
...
4. Desenvolva/coordene as entregas (delegando migrations ao `dba-postgres-rls` e seguindo a fronteira de camadas), priorizando essenciais e dimensões de peso 4/3 — incluindo as **Atividades Finalísticas do Legislativo** (peso 3: leis/normas, projetos/tramitação, pautas, atas, votações nominais, sessões/TV Câmara, cotas parlamentares) — e os itens transversais (atualidade, série histórica, download, filtro).
