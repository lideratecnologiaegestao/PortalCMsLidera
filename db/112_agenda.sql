-- =====================================================================
-- 112 — Agenda (Legislativa/Administrativa): calendário unificado
-- =====================================================================
...
--
-- O calendário sobrepõe (read-only) as sessões plenárias (104_sessoes) e os
-- eventos institucionais (108_eventos) — feito no AgendaService, sem FK aqui.
-- Tenant-scoped + RLS. Ver api/src/modules/agenda/.
-- =====================================================================
...
CREATE TABLE IF NOT EXISTS agenda_itens (
  ...
  CONSTRAINT agenda_tipo_check CHECK (tipo IN (
    'evento','reuniao','audiencia_publica','sessao','feriado','ponto_facultativo',
    'data_comemorativa','programacao','prazo','votacao','mocao','outro')),
