-- =====================================================================
-- 106 — L4 Escola Legislativa (Cursos, Provas, Certificados)
-- =====================================================================
-- Plataforma de educação cidadã da câmara: cursos (módulos → aulas em
...
-- Origem Laravel: Curso*, CursoProva/Questao/Opcao/Tentativa*, CursoInscricao,
-- CursoCertificado, Certificate*. Ver specs/escola-legislativa.md.
--
